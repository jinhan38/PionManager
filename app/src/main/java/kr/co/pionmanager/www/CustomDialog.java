...
public class CustomDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.logout_dialog_contents);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
        bt_logout_yes = findViewById(R.id.bt_logout_yes);
        bt_logout_no = findViewById(R.id.bt_logout_no);

        bt_logout_yes.setOnClickListener(negativeListener);
        bt_logout_no.setOnClickListener(positiveListener);

        progressBar = findViewById(R.id.standard_progressBar);
        ll_customDialog_button = findViewById(R.id.ll_customDialog_button);
