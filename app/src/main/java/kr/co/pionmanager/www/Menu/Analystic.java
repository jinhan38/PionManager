...
public class Analystic extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int progress) {
                ...
                if (Get_Internet(Analystic.this) > 0) {
                    if (progress == 100) {
...
//        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl(Util.thepion_URL + "Mobile/m_Views/Manager/StatisticsPay_m");
        Util.SetLog(Util.thepion_URL + "Mobile/m_Views/Manager/StatisticsPay_m");
